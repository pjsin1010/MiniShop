...
function firstChange() {
 var x = document.frmSell.id20.options.selectedIndex;
 var groups=document.frmSell.id20.options.length;
...
function firstChange1() {
 var x = document.frmSell.id22.options.selectedIndex;
 var groups=document.frmSell.id22.options.length;
 var group=new Array(groups);
 for (i=0; i<groups; i++)
  group[i]=new Array();
