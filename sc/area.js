...
function firstChange() {
 var x = document.form.id9.options.selectedIndex;
 var groups=document.form.id9.options.length;
...
function firstChange1() {
 var x = document.form.id7.options.selectedIndex;
 var groups=document.form.id7.options.length;
 var group=new Array(groups);
 for (i=0; i<groups; i++)
  group[i]=new Array();
